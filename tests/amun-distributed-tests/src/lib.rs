...
mod tests {
    ...
    fn test_distributed_vote_uniqueness() {
        ...
        let v2 = ConsensusVote::new(2, pos, 0, ConsensusPhase::Prevote, Some([0xAA; 32]), [2u8; 64], 25);
        let v3 = ConsensusVote::new(3, pos, 0, ConsensusPhase::Prevote, Some([0xAA; 32]), [3u8; 64], 25);
        let v4 = ConsensusVote::new(4, pos, 0, ConsensusPhase::Prevote, Some([0xAA; 32]), [4u8; 64], 25);
    ...
    fn test_duplicate_detection() {
        ...
        let v1 = ConsensusVote::new(1, pos, 0, ConsensusPhase::Prevote, Some([0xAA; 32]), [1u8; 64], 25);
        let v1_dup = ConsensusVote::new(1, pos, 0, ConsensusPhase::Prevote, Some([0xAA; 32]), [2u8; 64], 25);
