...
fn build_block_with_evidence(height: u64, parent_hash: [u8; 32], evidence_root: [u8; 32]) -> Block {
...
fn p2_evidence_root_changes_block_hash() {
    ...
    assert_ne!(
        block1.evidence_root, block2.evidence_root,
