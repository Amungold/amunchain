...
fn main() {
    ...
    let validators: Vec<LiveValidator> = (0..count)
        .map(|i| {
            let config = ValidatorConfig {
                ...
                data_dir: format!("/tmp/amun-bench10e-{}", i),
                quorum_size: Some(count),
                authority_public_key: amun_live_cluster::config::load_genesis_authority(concat!(
    ...
    println!("\n============================================");
    println!("  N83.1 10-VALIDATOR EVENT-DRIVEN RESULTS");
    println!("============================================");
