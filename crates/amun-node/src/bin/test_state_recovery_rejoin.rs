...
fn main() {
    ...
    let make_node = |i: usize| -> NetworkNode { NetworkNode::new([i as u8; 32]) };
    ...
    println!(
        "Pre-crash height: {}, roots converge: {}",
        pre_height,
    ...
    println!(
        "Validator 2 recovered state root: {}",
    ...
    println!(
        "Validator 4 recovered state root: {}",
        hex::encode(recovered_store_4.state_root())
    );
