...
fn n148_fuzz_mint_1000_iterations() {
    ...
    assert!(
        result.passed(),
        "Fuzz mint failed: {} crashes, {} invariants broken",
        result.crashes,
        result.state_invariants_broken
    );
}
...
fn n148_fuzz_marketplace_500_iterations() {
    ...
    assert!(
        result.passed(),
        "Fuzz marketplace failed: {} crashes, {} invariants broken",
        result.crashes,
        result.state_invariants_broken
    );
}
...
fn n148_fuzz_royalty_10000_iterations() {
    ...
    assert!(
        result.passed(),
        "Fuzz royalty failed: {} crashes, {} invariants broken",
        result.crashes,
        result.state_invariants_broken
    );
}
...
fn n148_fuzz_governance_1000_iterations() {
    ...
    assert!(
        result.passed(),
        "Fuzz governance failed: {} crashes, {} invariants broken",
        result.crashes,
        result.state_invariants_broken
    );
}
...
fn n148_fuzz_bridge_1000_iterations() {
    ...
    assert!(
        result.passed(),
        "Fuzz bridge failed: {} crashes, {} invariants broken",
        result.crashes,
        result.state_invariants_broken
    );
}
