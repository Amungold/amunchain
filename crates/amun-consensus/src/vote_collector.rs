use crate::types::{Hash256, QuorumCertificate, Vote, VoteType};
...
pub struct VoteCollector {
    votes: HashMap<VoteKey, Vec<Vote>>,
    formed_qcs: HashSet<VoteKey>,
}
impl VoteCollector {
    pub fn new() -> Self {
        Self {
            votes: HashMap::new(),
            formed_qcs: HashSet::new(),
        }
    }
    pub fn add_vote(
        &mut self,
        ...
        if self.formed_qcs.contains(&key) {
            return None;
        }
