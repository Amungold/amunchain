...
fn n145_mint_and_query_via_sdk() {
    ...
    sdk.mint_nft(col, token, owner, &NftMetadata {
        name: "Test".into(),
    ...
    sdk.constitutional_registry.lock().unwrap().register(
        amun_nft_constitutional_registry::NftConstitutionalRecord {
            token_id: token, owner, collection_id: Some(col), creator: owner,
...
fn n145_transfer_via_sdk() {
    ...
    sdk.registry.lock().unwrap().register_genesis(
        amun_resource_core::ResourceMetadata {
...
fn n145_full_sdk_integration_flow() {
    ...
    sdk.constitutional_registry.lock().unwrap().register(
        amun_nft_constitutional_registry::NftConstitutionalRecord {
            token_id: token, owner: buyer, collection_id: Some(col), creator,
