...
fn n171_fuzz_deploy_10000() {
    ...
    println!(
        "Deploy fuzz: {} deploys, {} failed, {} evidence mismatches",
...
fn n171_fuzz_call_5000() {
    ...
    println!(
        "Call fuzz: {} calls, {} failed, {} gas exhaustions, {} evidence mismatches",
        result.successful_calls,
        result.failed_calls,
        result.gas_exhaustions,
        result.evidence_mismatches
    );
    assert!(
        result.passed(),
...
fn n171_fuzz_gas_limits_5000() {
    ...
    println!(
        "Gas fuzz: {} calls, {} failed, {} gas exhaustions, {} evidence mismatches",
        result.successful_calls,
        result.failed_calls,
        result.gas_exhaustions,
        result.evidence_mismatches
