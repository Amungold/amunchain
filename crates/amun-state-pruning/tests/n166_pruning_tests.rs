...
fn n166_prune_by_height_reduces_active_set() {
    ...
    pr.registry.register_genesis(ResourceMetadata {
        resource_id: col_id,
    ...
    for i in 1..500u64 {
        ...
        pr.registry.derive_from_collection(&col_id, ResourceMetadata {
    ...
    println!("Active before: {}, pruned: {}, active after: {}", active_before, pruned, active_after);
...
fn n166_restore_archived_brings_back_resources() {
    ...
    println!("After prune: {}, restored: {}, after restore: {}", active_after_prune, restored, active_after_restore);
