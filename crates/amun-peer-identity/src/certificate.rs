...
impl PeerCertificate {
    pub fn self_sign(peer_id: super::peer_id::ConstitutionalPeerId, keypair: &ConstitutionalKeyPair) -> Self {
        ...
        Self { peer_id, signature: ConstitutionalSignature::new(sig, vk_hex) }
    }
}
